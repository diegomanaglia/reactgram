...
const userCreateValidation = () => {
    ...
    return [
        ...
        body("confirmPassword").isString().withMessage("A confirmação da senha é obrigatória.").custom((value, { req }) => {
...
const userUpdateValidation = () => {
    ...
    return [
        body("name").optional().isLength({ min: 3 }).withMessage("O nome precisa ter no mínimo 3 carateres."),
